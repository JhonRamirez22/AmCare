window.AmCareApp = (() => {
  ...
  ${mediaImg(MEDIA.connectedCare, 'Casos de referencia en salud digital', 'trust-image')}
  ...
  ${mediaImg(MEDIA.doctorTablet, 'Profesional médico usando tablet', 'specialty-image')}
